...
<img src="http://qiniu.storage.mikezh.com/dstwo_child_delete_1.jpg" width="500" alt="左右子树都不空删除1"/>
&nbsp;&nbsp;方法二：令p的直接前驱替代p，然后再从二叉排序树中删去它的直接前驱。当以直接前驱S替代p时，由于S只有左子树（或没有左子树），则在删去S之后，只要令SL为S的双亲的右子树即可。（如下图）<br/>
<img src="http://qiniu.storage.mikezh.com/dstwo_child_delete_2.jpg" width="500" alt="左右子树都不空删除2"/>
