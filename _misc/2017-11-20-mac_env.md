...
----mongodb
wget -nd https://fastdl.mongodb.org/osx/mongodb-osx-ssl-x86_64-3.6.2.tgz -P ~/Documents/lib/mongodb
cd ~/Documents/lib/mongodb
tar zxf mongodb-osx-ssl-x86_64-3.6.2.tgz
ln -s ~/Documents/lib/mongo/mongodb-osx-x86_64-3.6.2 ~/Documents/lib/mongo/current
vim ~/.bash_profile
export MONGODB=~/Documents/lib/mongo/current
